...
namespace TerrainEngine
{
    class Decoration
    {
        static readonly Dictionary<string, Tuple<double, string>[]> decors = new Dictionary<string, Tuple<double, string>[]>()
        {
            ...
            { "mountain", new []
                {
                    new Tuple<double, string>(0.01, "Rock Grey"),
					new Tuple<double, string>(0.02, "Fir Tree 1"),
					new Tuple<double, string>(0.02, "Fir Tree 2"),
					new Tuple<double, string>(0.02, "Fir Tree 3"),
					new Tuple<double, string>(0.01, "Small Fir Tree 1"),
                    new Tuple<double, string>(0.01, "Small Fir Tree 2"),
