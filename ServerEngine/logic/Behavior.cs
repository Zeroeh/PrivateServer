...
namespace ServerEngine.logic
{
    ...
    class CheckConditionEffects : Behavior
    {
        ...
        static readonly Dictionary<ConditionEffects[], CheckConditionEffects> instances = new Dictionary<ConditionEffects[], CheckConditionEffects>();
    ...
    class PlaySound : Behavior
    {
        ...
        static readonly Dictionary<int, PlaySound> instances = new Dictionary<int, PlaySound>();
