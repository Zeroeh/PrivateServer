...
namespace ServerEngine.logic.loot
{
    ...
    {
        public static readonly int[] WeaponsT = new int[] { 1, 2, 3, 8, 17, 24 };
        public static readonly int[] AbilityT = new int[] { 4, 5, 11, 12, 13, 15, 16, 18, 19, 20, 21, 22, 23, 25 };
    ...
    class StatPotionsLoot : ILoot
    {
        ...
        {
            new StatPotion[] { StatPotion.Atk, StatPotion.Def, StatPotion.Spd },
