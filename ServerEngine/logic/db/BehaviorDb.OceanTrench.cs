    ...
    partial class BehaviorDb
    {
        static _ OceanTrench = Behav()
            .Init(0x1706, Behaves("Thessal the Mermaid Goddess",
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(800, new LootDef(0, 5, 0, 3,
                            Tuple.Create(0.03, (ILoot)new ItemLoot("Coral Bow")),
                            Tuple.Create(0.08, (ILoot)new ItemLoot("Coral Silk Armor")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Coral Ring")),
                            Tuple.Create(0.5, (ILoot)new ItemLoot("Coral Venom Trap")),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Coral Juice")),
            ...
            .Init(0x1705, Behaves("Coral Gift",
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(800, new LootDef(0, 5, 0, 3,
                            Tuple.Create(0.035, (ILoot)new ItemLoot("Coral Bow")),
                            Tuple.Create(0.06, (ILoot)new ItemLoot("Coral Silk Armor")),
                            Tuple.Create(0.09, (ILoot)new ItemLoot("Coral Ring")),
                            Tuple.Create(0.04, (ILoot)new ItemLoot("Coral Venom Trap")),
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Coral Juice")),
                            Tuple.Create(1.0, (ILoot)new StatPotionLoot(StatPotion.Mana))
                        ))
                )
