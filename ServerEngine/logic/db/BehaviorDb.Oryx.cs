		...
		static _ Oryx = Behav()
			.Init(0x0932, Behaves("Oryx the Mad God 2",
					...
					loot: new LootBehavior(LootDef.Empty,
						Tuple.Create(100, new LootDef(0, 10, 0, 3,
			...
			.Init(0x2001, Behaves("Oryx the Mad God 3",
				...
				loot: new LootBehavior(LootDef.Empty,
						Tuple.Create(100, new LootDef(0, 5, 0, 8,
							Tuple.Create(0.01, (ILoot)new ItemLoot("Orb of the Chaos Walker")),
							Tuple.Create(0.25, (ILoot)new ItemLoot("Potion of Oryx"))
				))),
				condBehaviors: new ConditionalBehavior[] {
					new OnDeath(new SimpleTaunt("One day I WILL win...")),
				}
			))
			...
			.Init(0x2003, Behaves("Knight of the Void",
				...
				loot: new LootBehavior(LootDef.Empty,
						Tuple.Create(100, new LootDef(0, 1, 0, 8,
							Tuple.Create(0.001, (ILoot)new ItemLoot("Potion of Zeroeh"))
				)))
			))
