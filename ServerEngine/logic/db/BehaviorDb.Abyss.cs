            ...
            .Init(0x090a, Behaves("Archemon Malphas",
                new RunBehaviors(
                    ...
                    new State("attack",
                        ...
                        Cooldown.Instance(100, SimpleAttack.Instance(8)),
                    ...
                    new State("large",
                        ...
                        Cooldown.Instance(100, SimpleAttack.Instance(8, projectileIndex: 2)),
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(800, new LootDef(0, 5, 1, 2,
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Demon Blade")),
                ...
                new RunBehaviors(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                       Tuple.Create(100, new LootDef(0, 5, 0, 10,
                            ...
                            Tuple.Create(0.02, (ILoot)new ItemLoot("Sword of Illumination")),
                            Tuple.Create(0.02, (ILoot)new ItemLoot("Demon Blade"))
            )))));
    }
}
