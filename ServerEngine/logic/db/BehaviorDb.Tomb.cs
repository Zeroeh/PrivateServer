        ...
        .Init(0x0d28, Behaves("Tomb Defender",
                ...
                new RunBehaviors(
                    ...
                    new State("artifacts",
                        ...
                        //Reproduce.Instance(0x0d24, 4, 1500, 4), //These three lines keep spawning artifacts, which hog up RAM on ServerEngine
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 10, 0, 8,
                            ...
                            Tuple.Create(0.03, (ILoot)new ItemLoot("Tome of Holy Protection")),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.03, (ILoot)new ItemLoot("Ring of the Pyramid"))
                )))
            ...
            .Init(0x0d26, Behaves("Nut",
                new RunBehaviors(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                            Tuple.Create(100, new LootDef(0, 10, 0, 8,
                            Tuple.Create(0.03, (ILoot)new ItemLoot("Ring of the Nile")),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Ra's Sun Scroll")),
                            Tuple.Create(1.0, (ILoot)new ItemLoot("Potion of Life"))
            ...
            .Init(0x0d27, Behaves("Geb",
                    ...
                    HpLesserPercent.Instance(0.5f, /*If HP is less than 50%, run new behaviors*/
                        ...
                        loot: new LootBehavior(LootDef.Empty, //Class for loot.
                          Tuple.Create(100, new LootDef(0, 10, 0, 8,
                            Tuple.Create(1.0, (ILoot)new StatPotionLoot(StatPotion.Life)),
                            Tuple.Create(0.3, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Ra's Sun Scepter")),
                            Tuple.Create(0.03, (ILoot)new ItemLoot("Ring of the Sphinx"))
                            ))
                        )
                ))
                ...
                IfNot.Instance(
                    ...
                    loot: new LootBehavior(
                        new LootDef(0, 2, 0, 8,
                            Tuple.Create(0.3, (ILoot)HpPotionLoot.Instance),
                            Tuple.Create(0.3, (ILoot)MpPotionLoot.Instance)
                            ))
                    ))
                    ...
                    new RunBehaviors(
                        ...
                        loot: new LootBehavior(LootDef.Empty,
                          Tuple.Create(100, new LootDef(0, 3, 0, 8,
                            Tuple.Create(0.1, (ILoot)new ItemLoot("Health Potion"))
                            )))
                ))
