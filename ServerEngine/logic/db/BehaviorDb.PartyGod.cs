...
namespace ServerEngine.logic
{
    partial class BehaviorDb
    {
        static _ PartyGod = Behav()
            ...
            Cooldown.Instance(5000, Heal.Instance(5, 25000, 0x0e56)),
            new QueuedBehavior(
                HpLesser.Instance(10000,
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(6, 20, 6, 8,
                            Tuple.Create(0.9, (ILoot)new ItemLoot("Blue Paradise")),
                            Tuple.Create(0.9, (ILoot)new ItemLoot("Pink Passion Breeze")),
                            Tuple.Create(0.9, (ILoot)new ItemLoot("Bahama Sunrise")),
                            Tuple.Create(0.9, (ILoot)new ItemLoot("Lime Jungle Bay"))
                        ))
                    )
                ));
    }
