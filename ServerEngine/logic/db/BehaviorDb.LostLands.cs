        ...
        static _ LostLands = Behav()
            .Init(0x0d50, Behaves("Lord of the Lost Lands",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                            ...
                            Tuple.Create(0.8, (ILoot)new StatPotionLoot(StatPotion.Atk)),
                            Tuple.Create(0.8, (ILoot)new StatPotionLoot(StatPotion.Wis)),
                            Tuple.Create(0.8, (ILoot)new StatPotionLoot(StatPotion.Vit)),
                            Tuple.Create(0.8, (ILoot)new StatPotionLoot(StatPotion.Spd))
                           ))),
                           condBehaviors: new ConditionalBehavior[] {
                    new OnDeath(new SimpleTaunt("I shall have my revenge!")),
