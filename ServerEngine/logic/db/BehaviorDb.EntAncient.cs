        ...
        static _ EntAncient = Behav()
            .Init(0x091f, Behaves("Ent Ancient",
                    ...
                    new RunBehaviors(
                        ...
                        IfEqual.Instance(-1, 2,
                            new RunBehaviors(
                                Once.Instance(UnsetConditionEffect.Instance(ConditionEffectIndex.Armored)),
                                    ...
                                    DamageLesserEqual.Instance(4500,
                                        ...
                                        DamageLesserEqual.Instance(14400,
                                            new RunBehaviors(
                                                ...
                                                SpawnMinionImmediate.Instance(0x0924, 3, 1, 1),
            ...
            //Once.Instance(new SimpleTaunt("Cower before me, mortals!")),
                        ...
                        IfEqual.Instance(-1, 9,
                            new RunBehaviors(
                                ...
                                new QueuedBehavior(
                                    CooldownExact.Instance(4000, UnsetConditionEffect.Instance(ConditionEffectIndex.Armored)),
                                    CooldownExact.Instance(4000, SetConditionEffect.Instance(ConditionEffectIndex.Paralyzed))
                                ),
                                Cooldown.Instance(750, Rand.Instance(
            ...
            .Init(0x0924, Behaves("Actual Greater Nature Sprite",
                    ...
                    loot: new LootBehavior(
                        ...
                        Tuple.Create(100, new LootDef(0, 1, 0, 8,
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Quiver of Thunder")),
                            ...
                            Tuple.Create(0.20, (ILoot)new StatPotionLoot(StatPotion.Atk)),
