...
namespace ServerEngine.logic
{
    partial class BehaviorDb
    {
        static _ Draconis = Behav()
            .Init(0x7504, Behaves("Feargus the Demented",
                    new RunBehaviors(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(1, 8, 1, 2,
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Celestial Blade")),
                            Tuple.Create(0.02, (ILoot)new ItemLoot("Annoying Firecracker Katana")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Dagger of the Shadow Talon")),
            ...
            .Init(0x7499, Behaves("Nikao the Defiler",
                    new RunBehaviors(
                        IfExist.Instance(-1, NullBehavior.Instance,
                            new RunBehaviors(
                                new QueuedBehavior(
            ...
            .Init(0x7543, Behaves("Pyyr the Wicked",
                    new RunBehaviors(
                        IfExist.Instance(-1, NullBehavior.Instance,
                            new RunBehaviors(
                                new QueuedBehavior(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(1, 8, 1, 2,
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Fire Dragon Battle Armor")),
            ...
            .Init(0x7541, Behaves("Limoz the Plague Bearer",
                    new RunBehaviors(
                        IfExist.Instance(-1, NullBehavior.Instance,
                            new RunBehaviors(
                                new QueuedBehavior(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(1, 8, 1, 2,
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Leaf Dragon Hide Armor")),
                            Tuple.Create(0.07, (ILoot)new StatPotionLoot(StatPotion.Life)),
                            Tuple.Create(0.5, (ILoot)new StatPotionLoot(StatPotion.Def)),
                            Tuple.Create(0.5, (ILoot)new StatPotionLoot(StatPotion.Vit)),
                            Tuple.Create(0.5, (ILoot)new StatPotionLoot(StatPotion.Wis)),
                            Tuple.Create(0.5, (ILoot)new StatPotionLoot(StatPotion.Dex)),
            ...
            .Init(0x00479, Behaves("Loot Balloon",
                    new RunBehaviors(
                        SmoothWandering.Instance(0.5f, 0.5f)
                        ),
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 2, 0, 1,
                            Tuple.Create(0.0001, (ILoot)new ItemLoot("Crown")),
                            Tuple.Create(0.0001, (ILoot)new ItemLoot("Zeroeh's Doom Bow")),
                            Tuple.Create(0.0001, (ILoot)new ItemLoot("Zeroeh's Coral Bow")),
                            Tuple.Create(0.03, (ILoot)new StatPotionLoot(StatPotion.Life)),
                            Tuple.Create(0.06, (ILoot)new StatPotionLoot(StatPotion.Mana)),
                            Tuple.Create(0.5, (ILoot)new StatPotionLoot(StatPotion.Def)),
                            Tuple.Create(0.5, (ILoot)new StatPotionLoot(StatPotion.Vit)),
                            Tuple.Create(0.5, (ILoot)new StatPotionLoot(StatPotion.Wis)),
                            Tuple.Create(0.5, (ILoot)new StatPotionLoot(StatPotion.Dex)),
