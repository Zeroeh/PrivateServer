...
namespace ServerEngine.logic
{
    partial class BehaviorDb
    {
        static LootDef CommonGodSoulBag =
            new LootDef(0, 2, 0, 1,
                Tuple.Create(0.006, (ILoot)new TierLoot(9, ItemType.Weapon)),

                Tuple.Create(0.01, (ILoot)new TierLoot(9, ItemType.Armor)),
                Tuple.Create(0.002, (ILoot)new TierLoot(10, ItemType.Armor)),

                Tuple.Create(0.001, (ILoot)new TierLoot(4, ItemType.Ring)),
                Tuple.Create(0.008, (ILoot)new TierLoot(4, ItemType.Ability))
            );
        const double PotProbability = 0.02; // Prod drop rates of potions are 0.01-0.03
        ...
        static _ Mountain = Behav()
            .Init(0x651, Behaves("White Demon",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        ...
                        Tuple.Create(360, new LootDef(0, 1, 0, 8,
                            Tuple.Create(PotProbability, (ILoot)new StatPotionLoot(StatPotion.Atk))
                        ))
                    ),
            ...
            .Init(0x658, Behaves("Slime God",
                    ...
                    new RunBehaviors(
                        Cooldown.Instance(1000, PredictiveMultiAttack.Instance(12, 10 * (float)Math.PI / 180, 5, 1)),
