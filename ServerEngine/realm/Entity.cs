...
namespace ServerEngine.realm
{
    public class Entity : IBehaviorHost, IProjectileOwner, ICollidable<Entity>
    {
        ...
        Dictionary<int, object> oncestates;
        ...
        public Behavior[] Behaves { get { return new Behavior[] { AttackBehavior, MovementBehavior, ReproduceBehavior }; } }
        ...
        const int EFFECT_COUNT = 28; //Change
        int[] effects;
        bool tickingEffects = true; //was false
        ...
        public void ApplyConditionEffect(params ConditionEffect[] effs)
        {
            foreach (var i in effs)
            {
                ...
                if (i.Effect == ConditionEffectIndex.Stasis &&
                    ...
                    continue;
				if (i.Effect == ConditionEffectIndex.Cursed) //Check here for debugging
					continue;
