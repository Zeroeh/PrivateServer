...
{
    //The mad god who looks after the realm
    class Oryx
    {
        GameWorld world;
        ...
        int[] enemyMaxCounts = new int[13];
        int[] enemyCounts = new int[13];
        public void Init()
        {
        ...
        static readonly Tuple<string, TauntData>[] criticalEnemies = new Tuple<string, TauntData>[]
        {
            ...
            {
                spawn = new string[] {
                    "It's time you've met your match with a Cube God!"
                },
                numberOfEnemies = new string[] {
            ...
            Tuple.Create("Lord of the Lost Lands", new TauntData()
            {
                ...
                numberOfEnemies = new string[] {
                    "You dull-spirited apes! You shall pose no challenge for my Lord of the Lost Lands",
                    "Regret your choices, blasphemers! My Lord of the Lost Lands will teach you respect!",
                    "My Lord of the Lost Lands will bewitch you with their beauty!"
                },
                final = new string[] {
                    "You festering rat-catchers! A Grand Sphinx will make you doubt your purpose!",
                    "Gaze upon the beauty of the Grand Sphinx and feel your last hopes drain away."
            ...
            Tuple.Create("Hermit God", new TauntData()
            {
                ...
                killed = new string[] {
                    ...
                    "You naive imbecile, {PLAYER}! Without my Hermit God, Davy Jones is free to roam the seas without fear!"
                }
            }),
            ...
            Tuple.Create("Avatar of the Forgotten King", new TauntData()
            {
                spawn = new string[] {
                    "The Shatters has been discovered?!"
                },
                final = new string[] {
                    "I do not control the Avatar, but you will find it to be a great challenge!"
                },
                killed = new string[] {
                    "How could simpletons like you kill the Avatar of the Forgotten King!?"
                }
            }),
            Tuple.Create("Eye of the Dragon", new TauntData()
            {
                spawn = new string[] {
                    "The Rock Dragon has been summoned!"
                },
                numberOfEnemies = new string[] {
                    "Saps! My Rock Dragons will blast you away!",
                    "Loathsome slugs! My {COUNT} Rock Dragons will smear you!"
                },
                final = new string[] {
                    "Saps! My Rock Dragon will blast you away!"
                },
                killed = new string[] {
                    "You are a worthless sub-creature, {PLAYER}."
                }
            }),
            Tuple.Create("Pentaract", new TauntData()
            {
                spawn = new string[] {
                    "A Megaract has been built."
                },
                numberOfEnemies = new string[] {
                    "My Megaracts are more than a match for you!",
                    "My {COUNT} Megaracts will keep this realm closed forever!"
                },
                final = new string[] {
                    "My Megaract will keep you occupied!"
                },
                killed = new string[] {
                    "You will regret destroying my Megaract."
                }
            }),
        };
        ...
        List<Tuple<string, ISetPiece>> events = new List<Tuple<string, ISetPiece>>()
        {
            ...
            Tuple.Create("Avatar of the Forgotten King", (ISetPiece) new Unknown()),
            Tuple.Create("Rock Dragon", (ISetPiece) new RockDragon()),
        };
