...
namespace ServerEngine.realm.entities.player
{
    public class Combinations
    {
        ...
        {
            // ---- ADVANCED COMBOS ---- //
            AddAdvCombo("Doom Bow", 12000, "Robe of the Ancient Intellect", "Robe of the Star Mother", "Robe of the Grand Sorcerer");
            AddAdvCombo("Demon Blade", 12000, "Annihilation Armor", "Dominion Armor", "Acropolis Armor");
            AddAdvCombo("Dirk of Cronus", 12000, "Hydra Skin Armor", "Wyrmhide Armor", "Leviathan Armor");
