...
namespace ServerEngine.realm.entities //new ability behaviors go here
{
    partial class Player
    {
        private bool buttonDown; //this code can prolly be commented, but I don't feel like messing with shit tonight
        ...
        static readonly ConditionEffect[] NegativeEffs = new ConditionEffect[]
        {
			...
			new ConditionEffect()
			{
				Effect = ConditionEffectIndex.Cursed,
				DurationMS = 0
			},
        };
...
//SPELLBOMB CODE LIBRARY
//I felt like making this cause the different spellbomb behaviors you can make are amazing if you know math.
// time.tickTimes, target, (float)((i * Math.PI) / 2)); This is a code for a 4 point. Shots move in a + sign pattern
// time.tickTimes, target, (float)((i * Math.PI) / 4)); This is a code for a 6 point. Shots move in a + and x sign pattern.