	...
	public partial class Player : Character, IContainer, IPlayer
	{
		...
		public void UsePortal(RealmTime time, UsePortalPacket pkt)
		{
			...
			if (world == null)
			{
				if (p != null)
				{
					...
					else
					{
						switch (entity.ObjectType) //handling default case for not found. Add more as implemented
						{
							...
							case 0x0ffa: //these need to match IDs of the portal, not the key
							...
							case 0x0717:
								world = RealmManager.AddWorld(new PirateCave()); break;
							case 0x0719:
								world = RealmManager.AddWorld(new SpiderDen()); break;
							case 0x0733:
								world = RealmManager.AddWorld(new ForbiddenJungle()); break;
							case 0x0890:
							...
							case 0x753e:
								world = RealmManager.AddWorld(new Draconis()); break;
							case 0x2228:
								world = RealmManager.AddWorld(new ShadowWell()); break;
							case 0x195d:
								world = RealmManager.AddWorld(new MarketMap()); break;
							case 0x00493:
								world = RealmManager.AddWorld(new Tinkerer()); break;
							case 0x2243:
								world = RealmManager.AddWorld(new RealNexus()); break;
							case 0x195f:
				...
				{
					switch (entity.ObjectType) // Special Portals that cannot be the portal class, such as guild hall
					{
						case 0x072f:
		...
		public void Teleport(RealmTime time, int objId)
		{
			if (!this.TPCooledDown())
			{
				psr.SendPacket(new TextPacket()
				{
					...
					Stars = -1,
					Name = "",
					Text = "Wait 10 seconds to teleport again!"
				});
				return;
			}
			SetTPDisabledPeriod();
