...
[Flags]
public enum ConditionEffects //This file defines all xml tags
{
    Dead = 1 << 0,
    Quiet = 1 << 1,
    Weak = 1 << 2,
...
public enum ActivateEffects //You need to put any custom ability behaviors in here to make them work!!
{
    Shoot,
    StatBoostSelf,
    StatBoostAura,
    BulletNova,
    InvertNova, //custom inverted bullet nova, just paste the effect name into this list
    ConditionEffectAura,
    ConditionEffectSelf,
    Heal,
    HealNova,
...
public class ActivateEffect
{
    ...
    public ActivateEffect(XElement elem)
    {
        ...
        if (elem.Attribute("color") != null)
            Color = uint.Parse(elem.Attribute("color").Value.Substring(2), System.Globalization.NumberStyles.AllowHexSpecifier);
    }
}
